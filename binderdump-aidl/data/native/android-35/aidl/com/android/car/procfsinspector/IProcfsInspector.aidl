...
//         (android14-release) — android15-release returns 404; android14-release is the
//         most recent branch with this file. This is the actual upstream AIDL, not a C++ enum.
