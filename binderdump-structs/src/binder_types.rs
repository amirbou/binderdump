...
pub enum binder_ioctl {
    BINDER_WRITE_READ =
        request_code_readwrite!('b', 1, size_of::<binderdump_sys::binder_write_read>()),
    ...
    #[default]
    BINDER_VERSION = request_code_readwrite!('b', 9, size_of::<binderdump_sys::binder_version>()),
    BINDER_GET_NODE_DEBUG_INFO =
        request_code_readwrite!('b', 11, size_of::<binderdump_sys::binder_node_debug_info>()),
    BINDER_GET_NODE_INFO_FOR_REF = request_code_readwrite!(
        'b',
        12,
        size_of::<binderdump_sys::binder_node_info_for_ref>()
    ),
    BINDER_SET_CONTEXT_MGR_EXT =
        request_code_write!('b', 13, size_of::<binderdump_sys::flat_binder_object>()),
    BINDER_FREEZE = request_code_write!('b', 14, size_of::<binderdump_sys::binder_freeze_info>()),
    BINDER_GET_FROZEN_INFO = request_code_readwrite!(
        'b',
        15,
        size_of::<binderdump_sys::binder_frozen_status_info>()
    ),
