...
pub enum binder_ioctl {
    ...
    BINDER_GET_NODE_DEBUG_INFO	= request_code_readwrite!('b', 11, size_of::<gen::binder_node_debug_info>()),
    BINDER_GET_NODE_INFO_FOR_REF	= request_code_readwrite!('b', 12, size_of::<gen::binder_node_info_for_ref>()),
    ...
    BINDER_GET_FROZEN_INFO		= request_code_readwrite!('b', 15, size_of::<gen::binder_frozen_status_info>()),
...
pub enum binder_command {
    ...
    BC_REQUEST_DEATH_NOTIFICATION = gen::binder_driver_command_protocol_BC_REQUEST_DEATH_NOTIFICATION,
...
pub enum binder_result {
    ...
    BR_CLEAR_DEATH_NOTIFICATION_DONE = gen::binder_driver_return_protocol_BR_CLEAR_DEATH_NOTIFICATION_DONE,
